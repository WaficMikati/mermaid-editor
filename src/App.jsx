...
import {
  ...
  rectFromPoints,
  rectIntersects,
  isPointInHoverExitArea,
  computeGraphBounds,
  snapNodeTopLeftToCenterGrid,
...
const {
  ...
  DELETE_TAB_WIDTH,
  DELETE_TAB_HEIGHT,
  LABEL_WRAP_CHAR_LIMIT,
  NODE_LABEL_FONT_SIZE,
  NODE_LABEL_LINE_HEIGHT,
  NODE_LABEL_CHAR_WIDTH,
  NODE_LABEL_PAD_X,
  NODE_LABEL_BOX_VERTICAL_PAD,
  NODE_CONNECT_ICON_SIZE,
  NODE_CONNECT_ICON_GAP,
  NODE_TEXT_BLOCK_OUTER_PAD,
  NODE_LAYOUT_CHAR_STEP,
  DIAMOND_TEXT_EDGE_PAD,
  DIAMOND_FIT_RATIO,
  RESET_ZOOM_TOP_PADDING,
  NODE_CONTENT_INSET,
  NODE_SHAPES,
  NODE_BASE_LABELS,
  clamp,
  ...
  getWrappedLineCount,
  getBaseCharsPerLineForShape,
  getAdaptiveLabelLayout,
  canDiamondFitLabel,
  getDiamondRenderChipLayout,
  getNodeSizeForLabel,
  getAutoNodeLabel,
} = graphUtils
...
// geometry helpers now imported from geometryUtils.js
...
export default function MermaidEditor() {
  ...
  const handleCanvasPointerDown = useCallback(
    (e) => {
      ...
      // Right-click or middle-click pans regardless of active tool.
